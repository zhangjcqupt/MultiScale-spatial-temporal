...
# ROOT_DATASET = '/raid/zhangj/Dataset/ERA_Dataset/Images'
# ROOT_DATASET = '/raid/zhangj/Dataset/Drone-action/Images_resize'
# ROOT_DATASET = '/raid/zhangj/Dataset/Drone-action/Images_sample'
# ROOT_DATASET = '/raid/zhangj/Dataset/Drone-action/Images_7sample'
# ROOT_DATASET = '/raid/zhangj/Dataset/Drone-action/Images_6sample'
# ROOT_DATASET = '/raid/zhangj/Dataset/Drone-action/Images_normal'
ROOT_DATASET = '/raid/zhangj/Dataset/MOD20_Split_central/Image_first'
...
def return_era(modality):
    ...
    if modality in ['RGB', 'PA', 'Lite']:
        ...
        filename_imglist_train = 'Tra.txt'
        filename_imglist_val = 'Test.txt'
        prefix = 'img_{:05d}.jpg'
    elif modality == 'Flow':
        root_data = ROOT_DATASET #+ 'Flow'
...
def return_MOD20FIRST(modality):
    # filename_categories = 'categories.txt'
    filename_categories = 'categories.txt'
    if modality in ['RGB', 'PA', 'Lite']:
        root_data = ROOT_DATASET #+ 'Images'
...
def return_dataset(dataset, modality):
    dict_single = {'jester': return_jester, 'something': return_something, 'somethingv2': return_somethingv2,
                   ...
                   'kinetics': return_kinetics, 'era' : return_era, 'action' : return_act, 'mod20': return_MOD20FIRST}
